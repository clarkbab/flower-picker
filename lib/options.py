...
def parse_predict():
  ...
  parser.add_option('-g', '--gpu', action='store_true', dest='gpu', help='train on a GPU. (default=false)')
  parser.add_option('-k', '--top_k', dest='k', type='int', help='number of classes to show. (default=3)')
  parser.add_option('-n', '--category_names', dest='category_names', help='YAML mapping of categories to names. (default=/config/classes.json)')
